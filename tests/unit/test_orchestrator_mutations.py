...
def _make_engagement(**kwargs) -> EngagementContext:
    ...
    defaults = {
        ...
        "targets": ["10.0.0.1"],
        "allowed_tests": [
            "recon", "stub-test", "async-stub", "active-test",
            "destructive-test", "failing-async", "slow-test",
            "destruct-no-isol-attr", "destruct-no-isol-needed",
            "dryrun-capture", "exec-capture", "no-aexecute",
            "no-aexecute-fixed", "auth-check", "bad-ctx",
            "ctx-capture", "ctx-capture2", "ctx-capture3", "ctx-capture4",
            "empty-ctx-capture2", "json-ctx-capture", "fail-test",
        ],
